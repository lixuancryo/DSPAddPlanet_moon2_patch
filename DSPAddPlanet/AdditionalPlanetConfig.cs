...
namespace DSPAddPlanet
{
    struct AdditionalPlanetConfig
    {
        ...
        override public string ToString ()
        {
            ...
            str.Append("    ").Append("_HasOrbitAroundIndex: ").Append(_HasOrbitAroundIndex).Append("\r\n");
            str.Append("    ").Append("OrbitAroundIndex: ").Append(OrbitAroundIndex).Append("\r\n");
            ...
            str.Append("    ").Append("ThemeName: ").Append(ThemeName).Append("\r\n");
